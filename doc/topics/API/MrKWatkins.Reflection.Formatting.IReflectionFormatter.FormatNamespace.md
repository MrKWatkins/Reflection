# IReflectionFormatter.FormatNamespace Method
## Overloads
...
## FormatNamespace(MemberInfo) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-reflection-memberinfo)"}

Formats the specified [MemberInfo](https://learn.microsoft.com/en-gb/dotnet/api/System.Reflection.MemberInfo)&#39;s namespace.

```c#
public abstract string FormatNamespace(MemberInfo member);
```

## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-reflection-memberinfo)"}

| Name | Type | Description |
| ---- | ---- | ----------- |
| member | [MemberInfo](https://learn.microsoft.com/en-gb/dotnet/api/System.Reflection.MemberInfo) | The member. |

## Returns {id="returns-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-reflection-memberinfo)"}

[String](https://learn.microsoft.com/en-gb/dotnet/api/System.String)

A string representing `member`&#39;s namespace.
## FormatNamespace(String) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-string)"}

Formats the specified namespace.

```c#
public abstract string FormatNamespace(string @namespace);
```

## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-string)"}

| Name | Type | Description |
| ---- | ---- | ----------- |
| namespace | [String](https://learn.microsoft.com/en-gb/dotnet/api/System.String) | The namespace. |

## Returns {id="returns-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-string)"}

[String](https://learn.microsoft.com/en-gb/dotnet/api/System.String)

A string representing `namespace`.
## FormatNamespace(StringBuilder, MemberInfo) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-text-stringbuilder-system-reflection-memberinfo)"}

Formats the specified [MemberInfo](https://learn.microsoft.com/en-gb/dotnet/api/System.Reflection.MemberInfo)&#39;s namespace.

```c#
public abstract void FormatNamespace(StringBuilder output, MemberInfo member);
```

## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-text-stringbuilder-system-reflection-memberinfo)"}
...
## FormatNamespace(StringBuilder, String) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-text-stringbuilder-system-string)"}

Formats the specified namespace.

```c#
public abstract void FormatNamespace(StringBuilder output, string @namespace);
```

## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-text-stringbuilder-system-string)"}
...
## FormatNamespace(TextWriter, MemberInfo) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-io-textwriter-system-reflection-memberinfo)"}

Formats the specified [MemberInfo](https://learn.microsoft.com/en-gb/dotnet/api/System.Reflection.MemberInfo)&#39;s namespace.

```c#
public abstract void FormatNamespace(TextWriter output, MemberInfo member);
```

## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-io-textwriter-system-reflection-memberinfo)"}
...
## FormatNamespace(TextWriter, String) {id="mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-io-textwriter-system-string)"}
...
## Parameters {id="parameters-mrkwatkins-reflection-formatting-ireflectionformatter-formatnamespace(system-io-textwriter-system-string)"}
